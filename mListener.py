...
class mListenerThread(threading.Thread):
    ...
    def validateDigest(self, givenDigest, entropy, counter, data):
        ...
        hashfunc.update(str(self.config['SHARED_KEY']).encode('utf-8'))
        hashfunc.update(str(entropy).encode('utf-8'))
        hashfunc.update(str(counter).encode('utf-8'))
        hashfunc.update(str(data).encode('utf-8'))
        newDigest = hashfunc.hexdigest()
